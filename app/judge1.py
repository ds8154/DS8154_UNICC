...
OUTPUT FORMAT ENFORCEMENT: Your entire response MUST be exactly this JSON object. Replace every "..." with real content. All 9 protocol_id entries are required — omitting any one will cause a hard validation failure.
